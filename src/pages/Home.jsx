...
export function Home() {
	...
	<main className={styles.main}>
		...
		<img className={styles.image} src="./resources/create-pages.png" alt="Ups, aquí iba una imagen :c"/>
		<br/>
		<div className={styles.divisionH}>
			<div>
				<img className={styles.halfimage} src="./resources/programing.jpg" alt="Ups, aquí iba una imagen :c"/>
			</div>
			<div>
		...
		<div className={styles.divisionH}>
			...
			<div>
				<img className={styles.littleimage} src="./resources/no-card.jpg" alt="Ups, aquí iba una imagen :c"/>
			</div>
		</div>
	</main>
	<Footer />
