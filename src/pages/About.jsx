...
export function About() {
	return(<><h2>Gracias por escojer Fantasi</h2>
	<main className={styles.main}>
		...
		<div className={styles.divisionH}>
			<div className={styles.leftCont}>
				<p>Si te gusta mucho todo esto y quieres invitarnos unos tacos puedes hacerlo <a target="_blank" href="https://www.paypal.com">aquí</a> </p>
				...
				<p>Si eres programador o diseñador, puedes contribuir directamente al código <a target="_blank" href="https://www.github.com/diequint">aquí</a></p>
			</div>
